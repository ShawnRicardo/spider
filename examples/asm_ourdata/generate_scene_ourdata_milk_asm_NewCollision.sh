...
# Match examples/asm PickSpoonBowl robot/actuator defaults, but generate
# NewCollision trimmed capsule/box proxies for collision debugging.
env -u LD_LIBRARY_PATH python spider/preprocess/prepare_asm_mjcf_NewCollision.py \
