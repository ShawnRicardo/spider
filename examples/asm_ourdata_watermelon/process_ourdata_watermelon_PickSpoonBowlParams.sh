...
# watermelon_server-specific data conversion, following the current milk
# URDFCollision textured-object pipeline.

env -u LD_LIBRARY_PATH python spider/process_datasets/ourdata_textured_watermelon.py \
