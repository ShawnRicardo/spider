...
def _write_reward_breakdown_txt(
    ...
    components = [
        ...
        ("right_object_pos_rew", "right_object 槽位物体位置跟踪 reward"),
        ("right_object_rot_rew", "right_object 槽位物体旋转跟踪 reward"),
        ("left_object_pos_rew", "left_object 槽位物体位置跟踪 reward"),
        ("left_object_rot_rew", "left_object 槽位物体旋转跟踪 reward"),
    ...
    diagnostics = [
        ...
        ("right_object_pos_dist", "right_object 槽位物体位置误差，单位近似为米"),
        ("right_object_rot_dist", "right_object 槽位物体旋转误差，来自 quat_sub"),
        ("left_object_pos_dist", "left_object 槽位物体位置误差，单位近似为米"),
        ("left_object_rot_dist", "left_object 槽位物体旋转误差，来自 quat_sub"),
    ...
    lines.append("2. qpos_rew: 机器人关节角 + right_object/left_object 两个有效物体位姿的加权跟踪项。")
    ...
    lines.append("6. contact_rew: 接触点 reward；ourdata 双物体默认没有接触点数据，通常 contact_guidance=false 且该项为 0。")
    ...
    header = (
        ...
        "right_object_pos_rew_mean left_object_pos_rew_mean total_rew_mean rew_mean"
    )
    lines.append(header)
    for step_idx, info in enumerate(info_list):
        ...
        row_values = [
            ...
            _final_iteration_value(info, "left_object_pos_rew_mean"),
