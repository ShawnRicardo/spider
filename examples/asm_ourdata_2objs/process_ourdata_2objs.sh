...
WORKSPACE="${WORKSPACE:-preprocessed/robot}"
TASK="${TASK:-robot}"
RIGHT_OBJECT_ID="${RIGHT_OBJECT_ID:-obj_1}"
LEFT_OBJECT_ID="${LEFT_OBJECT_ID:-obj_0}"
RIGHT_OBJECT_NAME="${RIGHT_OBJECT_NAME:-right_obj}"
LEFT_OBJECT_NAME="${LEFT_OBJECT_NAME:-left_obj}"
