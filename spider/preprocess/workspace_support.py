...
def compute_workspace_support_spec(
    ...
    workspace_z_offset = table_surface_z + clearance - object_min_z
    ...
    if (
        ...
        # Mirror the previously generated back-side tabletop placement to the
        # robot's front side while keeping the same depth magnitude.
